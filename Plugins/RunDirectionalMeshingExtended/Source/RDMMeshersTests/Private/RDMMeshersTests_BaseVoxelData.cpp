...
bool FRDMMeshersTests_BaseVoxelData_VoxelIndex_RandomDirectIndex_Equals_OverloadedFIntVectorIndex::RunTest(
...
bool FRDMMeshersTests_BaseVoxelData_VoxelIndex_LastIndex::RunTest(const FString& Parameters)
{
	...
	// Act
	BaseVoxelDataDummy->CalculateVoxelData();
	const uint32 Index = BaseVoxelDataDummy->CalculateVoxelIndex(NumberOfVoxels - 1, NumberOfVoxels - 1,
	                                                             NumberOfVoxels - 1);
...
bool FRDMMeshersTests_BaseVoxelData_VoxelIndex_IndexIsOutOfChunkBounds::RunTest(const FString& Parameters)
{
	...
	// Act
	BaseVoxelDataDummy->CalculateVoxelData();
	const uint32 InvalidIndex = BaseVoxelDataDummy->CalculateVoxelIndex(NumberOfVoxels + 1, NumberOfVoxels + 1,
	                                                                    NumberOfVoxels + 1);
...
bool FRDMMeshersTestsBaseVoxelData_VoxelIndex_NotNegative::RunTest(const FString& Parameters)
{
	...
	// Assert
	// Negative coordinates should produce an out-of-range index (invalid)
	TestTrue("Negative voxel coordinate should result in an out-of-bounds index.",
	         NegativeIndex > BaseVoxelDataDummy->GetMaxVoxelsInChunk());
